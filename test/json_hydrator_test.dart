...
void main() {
  ...
  group('To Object', () {
    ...
    test(
        "aMapOfMaps",
        () => expect(generatedOuterClass.aMapOfMaps,
            equals(correctOuterClass.aMapOfMaps)));
    test(
        "aDateTime",
